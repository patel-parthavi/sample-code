 ...
 * Text Domain: cli-leandash-addon
 */
...
if ( ! defined( 'CLI_LD_ADDON' ) ) {
	define( 'CLI_LD_ADDON', '1.1.0' );
}
if ( ! defined( 'CLI_LD_ADDON_URL' ) ) {
	define( 'CLI_LD_ADDON_URL', plugins_url( '/', __FILE__ ) );
}
if ( ! defined( 'CLI_LD_ADDON_PATH' ) ) {
	define( 'CLI_LD_ADDON_PATH', plugin_dir_path( __FILE__ ) );
}
if ( ! defined( 'CLI_LD_ADDON_BASENAME' ) ) {
	define( 'CLI_LD_ADDON_BASENAME', plugin_basename( __FILE__ ) );
}
if ( ! defined( 'CLI_LD_ADDON_FILEPATH' ) ) {
	define( 'CLI_LD_ADDON_FILEPATH', __FILE__ );
}
if ( ! defined( 'CLI_LD_ADDON_SLUG' ) ) {
	define( 'CLI_LD_ADDON_SLUG', 'cli-leandash-addon' );
}
/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'controller/class-cli-controller.php';

/**
 * Main instance of MRC.
 *
 * Returns the main instance of cli_controller class prevent the need to use globals.
 *
 * @since  1.0.0
 *
 * @return object CLI_Controller
 */
function cli_controller_class_instance() {
	return CLI_Controller::instance();
}

// Global for backwards compatibility.
$GLOBALS['CLI_Controller'] = cli_controller_class_instance();
