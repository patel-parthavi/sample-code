<?php
/**
 * Media Partners functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package WordPress
 * @subpackage Media_Partners
 * @since 1.0
 */

/**
 * Media Partners only works in WordPress 4.7 or later.
 */
...
function media_setup() {
	 ...
	 * Translations can be filed at WordPress.org. See: https://translate.wordpress.org/projects/wp-themes/media
	 * If you're building a theme based on media Partners, use a find and replace
	 * to change 'media' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'media' );
	...
	add_image_size( 'media-featured-image', 2000, 1200, true );

	add_image_size( 'media-thumbnail-avatar', 100, 100, true );
	...
	register_nav_menus( array(
		'top'    => __( 'Top Menu', 'media' ),
		'quick-links' => __( 'Quick Links Menu', 'media' ),
		'social' => __( 'Social Links Menu', 'media' ),
	) );
	 ...
	 * specifically font, colors, and column width.
 	 */
	add_editor_style( array( 'assets/css/editor-style.css', media_fonts_url() ) );
 ...
 *
 * @since media Partners 1.0
 *
 * @param array  $urls           URLs to print for resource hints.
 * @param string $relation_type  The relation type the URLs are printed.
 * @return array $urls           URLs to print for resource hints.
 */
function media_resource_hints( $urls, $relation_type ) {
	if ( wp_style_is( 'media-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		$urls[] = array(
...
add_filter( 'wp_resource_hints', 'media_resource_hints', 10, 2 );
...
function media_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog Sidebar', 'media' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'media' ),
	...
	register_sidebar( array(
		'name'          => __( 'Newsletter Listing', 'media' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Add widgets here to appear in your footer.', 'media' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
 ...
 */
function media_excerpt_more( $link ) {
	if ( is_admin() ) {
		return $link;
	}
...
add_filter( 'excerpt_more', 'media_excerpt_more' );
 ...
 * @since media Partners 1.0
 */
function media_javascript_detection() {
	echo "<script>(function(html){html.className = html.className.replace(/\bno-js\b/,'js')})(document.documentElement);</script>\n";
}
add_action( 'wp_head', 'media_javascript_detection', 0 );

/**
 * Add a pingback url auto-discovery header for singularly identifiable articles.
 */
function media_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">' . "\n", get_bloginfo( 'pingback_url' ) );
	}
}
add_action( 'wp_head', 'media_pingback_header' );


add_action( 'init', 'action__init' );
function action__init(){

	wp_register_style( 'media-service', get_theme_file_uri( '/assets/css/service.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-leadership', get_theme_file_uri( '/assets/css/leadership.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-locations', get_theme_file_uri( '/assets/css/locations.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-about', get_theme_file_uri( '/assets/css/about.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-values', get_theme_file_uri( '/assets/css/our-values.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-announcements', get_theme_file_uri( '/assets/css/announcements.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-industries-list', get_theme_file_uri( '/assets/css/industries-list.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-industry-detail', get_theme_file_uri( '/assets/css/industry-detail.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-contact-us', get_theme_file_uri( '/assets/css/contact-us.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-insights', get_theme_file_uri( '/assets/css/insights.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-careers', get_theme_file_uri( '/assets/css/careers.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-whitepaper-list', get_theme_file_uri( '/assets/css/whitepaper-list.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-newsletter-list', get_theme_file_uri( '/assets/css/newsletter-list.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-whitepaper', get_theme_file_uri( '/assets/css/whitepaper.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-case-study', get_theme_file_uri( '/assets/css/case-study.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-newsletter-listing', get_theme_file_uri( '/assets/css/newsletter-listing.css' ), array( 'media-style' ), '1.0' );
    wp_register_style( 'media-events', get_theme_file_uri( '/assets/css/events.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-webinars', get_theme_file_uri( '/assets/css/webinars.css' ), array( 'media-style' ), '1.0' );
	wp_register_style( 'media-collateral', get_theme_file_uri( '/assets/css/collateral.css' ), array( 'media-style' ), '1.0' );
...
function media_scripts() {
	...
	wp_enqueue_style( 'media-fonts', media_fonts_url(), array(), null );
	wp_enqueue_style( 'fontawesome',get_theme_file_uri( '/assets/fonts/font-awesome.min.css' ) , array(), '4.7.0'  );
	wp_enqueue_style( 'media-fonts',get_theme_file_uri( '/assets/css/styles.min.css' ) , array(), '1.0'  );
	...
	// Theme stylesheet.
	wp_enqueue_style( 'media-style', get_stylesheet_uri() );
	wp_enqueue_style( 'media-design', get_theme_file_uri( '/assets/css/design.css' ), array('media-style'), '1.0' );
	...
	if ( 'dark' === get_theme_mod( 'colorscheme', 'light' ) || is_customize_preview() ) {
		wp_enqueue_style( 'media-colors-dark', get_theme_file_uri( '/assets/css/colors-dark.css' ), array( 'media-style' ), '1.0' );
	}
	...
	// wp_enqueue_script( 'media-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );



	wp_enqueue_script( 'media-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '1.0', true );
	wp_add_inline_script( 'media-global', inline_scripts() );
...
add_action( 'wp_enqueue_scripts', 'media_scripts' );
 ...
 */
function media_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
// add_filter( 'wp_calculate_image_sizes', 'media_content_image_sizes_attr', 10, 2 );
 ...
 */
function media_header_image_tag( $html, $header, $attr ) {
	if ( isset( $attr['sizes'] ) ) {
		$html = str_replace( $attr['sizes'], '100vw', $html );
	}
	return $html;
}
add_filter( 'get_header_image_tag', 'media_header_image_tag', 10, 3 );
 ...
 */
// function media_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
// 	return $attr;
// }
// add_filter( 'wp_get_attachment_image_attributes', 'media_post_thumbnail_sizes_attr', 10, 3 );
 ...
 */
function media_front_page_template( $template ) {
	return is_home() ? '' : $template;
}
add_filter( 'frontpage_template',  'media_front_page_template' );

/**
 * Modifies tag cloud widget arguments to display all tags in the same font size
 * and use list format for better accessibility.
 *
 * @since media Partners 1.4
 *
 * @param array $args Arguments for tag cloud widget.
 * @return array The filtered arguments for tag cloud widget.
 */
function media_widget_tag_cloud_args( $args ) {
	$args['largest']  = 1;
	$args['smallest'] = 1;
	$args['unit']     = 'em';
	$args['format']   = 'list';
...
add_filter( 'widget_tag_cloud_args', 'media_widget_tag_cloud_args' );
...
function my_error_notice() {
	...
	echo '<div class="error notice">
		<p>' . __( 'Please check address and update page again to dislay map.', 'media' ) . '</p>
	</div>';
}
			...
			echo '<div class="announcements-accordion wow fadeInUp">'.
				...
				'<div class="acc-cont">' .
					'<div class="Announcement-info flex flex-justify-start">' .
						...
						(
							get_the_time()
							? '<div class="announcements-time">'. get_the_time() .' '. __( 'Estern Daylight Time', 'media' ). '</div>'
							: ''
						) .
					'</div>' .
					(
...
function cptui_register_my_cpts() {
	...
	$labels = array(
		"name" => __( "Services", "media" ),
		"singular_name" => __( "Service", "media" ),
	);

	$args = array(
		"label" => __( "Services", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
	...
	$labels = array(
		"name" => __( "Leaderships", "media" ),
		"singular_name" => __( "Leadership", "media" ),
	);

	$args = array(
		"label" => __( "Leaderships", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
	...
	$labels = array(
		"name" => __( "Announcements", "media" ),
		"singular_name" => __( "Announcement", "media" ),
	);

	$args = array(
		"label" => __( "Announcements", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
		"publicly_queryable" => false,
	...
	$labels = array(
		"name" => __( "Career", "media" ),
		"singular_name" => __( "Career", "media" ),
	);

	$args = array(
		"label" => __( "Career", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
	...
	$labels = array(
		"name" => __( "Events", "media" ),
		"singular_name" => __( "Event", "media" ),
	);

	$args = array(
		"label" => __( "Events", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
		"publicly_queryable" => false,
	...
	/*
	$labels = array(
		"name" => __( "Newsletter", "media" ),
		"singular_name" => __( "Newsletter", "media" ),
	);

	$args = array(
		"label" => __( "Newsletter", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
	...
	*/
	...
	$labels = array(
		"name" => __( "White Pappers", "media" ),
		"singular_name" => __( "White Papper", "media" ),
	);

	$args = array(
		"label" => __( "White Pappers", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
	...
	$labels = array(
		"name" => __( "Webinars", "media" ),
		"singular_name" => __( "Webinar", "media" ),
	);

	$args = array(
		"label" => __( "Webinars", "media" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
		"publicly_queryable" => false,
...
function cptui_register_my_taxes() {
	...
	$labels = array(
		"name" => __( "Service Type", "media" ),
		"singular_name" => __( "Service Type", "media" ),
	);

	$args = array(
		"label" => __( "Service Type", "media" ),
		"labels" => $labels,
		"public" => true,
		"hierarchical" => true,
		"label" => "Service Type",
	...
	$labels = array(
		"name" => __( "Newletter Type", "media" ),
		"singular_name" => __( "Newletter Type", "media" ),
	);

	$args = array(
		"label" => __( "Newletter Type", "media" ),
		"labels" => $labels,
		"public" => true,
		"hierarchical" => true,
	...
	$labels = array(
		"name" => __( "Career Type", "media" ),
		"singular_name" => __( "Career Type", "media" ),
	);

	$args = array(
		"label" => __( "Career Type", "media" ),
		"labels" => $labels,
		"public" => true,
		"hierarchical" => true,
		"label" => "Career Type",
